...
export default function CrechePage() {
    ...
    const handleCheckIn = (appointmentId: string) => {
        ...
        showConfirm({
            ...
            message: `Deseja registrar o check-in do pet "${petName}" na Creche e iniciar o atendimento?`,
    ...
    const handleCheckOut = (appointmentId: string) => {
        ...
        showConfirm({
            ...
            message: `Deseja registrar o check-out do pet "${petName}" e encerrar a estadia na Creche?`,
