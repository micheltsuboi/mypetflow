...
export default function BanhoTosaPage() {
    ...
    const handleCheckIn = (appointmentId: string) => {
        ...
        showConfirm({
            ...
            message: `Deseja registrar o check-in do pet "${petName}" e iniciar o atendimento agora?`,
    ...
    const handleCheckOut = (appointmentId: string, type?: string) => {
        const currentObj = appointments.find(a => a.id === appointmentId)
        const petName = currentObj?.pets?.name || 'Pet'
        const typeLabel = type === 'a_caminho' ? 'a caminho da entrega' : 'aguardando retirada'
        
        showConfirm({
            title: 'Confirmar Saída (Check-out)',
            message: `Deseja registrar o check-out do pet "${petName}" como ${typeLabel}?`,
