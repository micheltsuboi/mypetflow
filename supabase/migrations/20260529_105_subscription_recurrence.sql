-- =====================================================
-- MIGRATION 105: Reestruturação de Mensalidades (Calendário e Frequência)
-- Diferenciação de serviços semanais recorrentes vs fixos mensais
-- =====================================================

-- 1. Adiciona coluna recurrence_type na tabela package_items
...
-- 2. Adiciona coluna recurrence_type na tabela package_credits
ALTER TABLE public.package_credits 
ADD COLUMN IF NOT EXISTS recurrence_type TEXT CHECK (recurrence_type IN ('fixed', 'weekly')) DEFAULT 'fixed';

-- 3. Recria a função de geração de sessões de mensalidade com suporte a tipo de recorrência
