-- =====================================================
-- MIGRATION: 106_fix_subscription_due_date.sql
-- DESCRIPTION: Corrige o cálculo de due_date na renovação automática de mensalidades
-- =====================================================
...
BEGIN
  ...
  -- Busca o billing_day real do plano associado à mensalidade
  SELECT COALESCE(sp.billing_day, 10) INTO v_billing_day
  ...
  SET
    ...
    due_date = (v_month_start + (v_billing_day - 1) * INTERVAL '1 day')::DATE
